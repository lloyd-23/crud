package com.gtaappdevelopers.firebasecruapplication;
...
public class AddCourseActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        courseNameEdt = findViewById(R.id.edEdtCourseName);
        coursePriceEdt = findViewById(R.id.edEdtCoursePrice);
        courseSuitedForEdt = findViewById(R.id.edEdtCourseSuitedFor);
        courseImgEdt = findViewById(R.id.edEdtCourseImageLink);
        courseLinkEdt = findViewById(R.id.edEdtCourseLink);
        courseDescEdt = findViewById(R.id.edEdtCourseDesc);
